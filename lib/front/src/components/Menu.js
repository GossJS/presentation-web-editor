...
class Menu extends Component {
  ...
  getFileItems() {
    ...
    let fileItems = [
      ...
      {
        label:
					`${this.props.label('Save')} ${this.props.currentFileName}`,
      ...
      .concat([
        ...
        },
        {
          ...
          submenu: this.props.uiConf.customThemes.map(themeName => ({
            ...
            click: () =>
              this.props.setTheme(themeName.toLowerCase()),
          })),
        },
        {
  ...
  getSlideTransitionMenuItem() {
    return this.transitions.slice(1).map(transitionName => ({
      ...
      click: () =>
        this.props.insert(`transition="${transitionName.toLowerCase()}"', 'transition="[^"]+"`),
    }));
  }
  ...
  getTransitionMenuItems() {
    return this.transitions.map(transitionName => ({
      ...
      type: 'radio',
      checked:
				this.props.configuration.transition ===
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: (menuItem) => {
              this.props.setUiConf({
                showButtonText: menuItem.checked,
              });
            },
          },
        ],
