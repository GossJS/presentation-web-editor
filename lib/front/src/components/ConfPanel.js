      ...
      >
        <InputWrapper name="autoSlideWrapper">
          <Label
            ...
            text={
							this.props.labels[
								'Auto play velocity (0 to disable)'
							]
						}
          />
          <input
        ...
        <InputWrapper name="viewDistanceWrapper">
          <Label
            inputId="viewDistance"
            text={
							this.props.labels[
								'Number of slides preloaded in lazy load mode'
							]
						}
          />
          <input
        ...
        <InputWrapper name="parallaxBackgroundSizeWrapper">
          <Label
            inputId="parallaxBackgroundSize"
            text={
							this.props.labels[
          ...
          />
          <input
            id="parallaxBackgroundSize"
            type="text"
            value={this.state.parallaxBackgroundSize}
            onChange={e =>
							this.handleChange(e, 'parallaxBackgroundSize')
						}
          />
        </InputWrapper>
        ...
        <OpenFile
          ...
          finalAction={path =>
						setConfiguration({ parallaxBackgroundImage: path })
					}
          fileType="img"
          handler={(imgPath) => {
        ...
        <InputWrapper name="parallaxBackgroundWrapper">
          ...
          <div className="parallaxBackgroundInputWrapper">
            <Label
              inputId="parallaxBackgroundHorizontal"
              text={this.props.labels.Horizontal}
            />
            <input
              id="parallaxBackgroundHorizontal"
              type="number"
              value={
								this.state.parallaxBackgroundHorizontal || ''
							}
              onChange={e =>
								this.handleChange(
									e,
          ...
          <div className="parallaxBackgroundInputWrapper">
            <Label
              inputId="parallaxBackgroundVertical"
              text={this.props.labels.Vertical}
            />
            <input
              id="parallaxBackgroundVertical"
              type="number"
        ...
        <div className="buttonRow">
          <Button
            clickHandler={() => this.props.setDefaultExtraConf()}
            text={this.props.labels['Revert to default']}
          />
        </div>
      </Panel>
    );
