      ...
      <section className="controls">
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 90 90"
            className="icon icon--savePresentation"
          >
        ...
        <button
          id="insertSlide"
          onClick={() => this.props.insert('::::slide\n\n::::')}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 90 90"
            className="icon icon--insertSlide"
          >
            <path
              id="path4140"
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 90 90"
            className="icon icon--insertImage"
          >
            <path
              id="path4142"
              d="m 14.4707,17.6621 c -2.8548,0 -5.13672,2.3552 -5.13672,5.1348 l 0,44.4062 c 0,2.8547 2.35712,5.1348 5.13672,5.1348 l 61.0586,0 c 2.8548,0 5.1367,-2.3552 5.1367,-5.1348 l 0,-44.4062 c 0,-2.8199 -2.3167,-5.1348 -5.1367,-5.1348 l -61.0586,0 z m -0,4.7168 61.0605,0 c 0.2251,0 0.416,0.1338 0.416,0.418 l 0,44.4062 a 1.52558,1.52558 0 0 0 0,0 c -0,0.2255 -0.133,0.416 -0.4141,0.416 l -61.0605,0 c -0.2286,0 -0.4199,-0.1356 -0.4199,-0.418 l 0,-44.4062 c 0,-0.2252 0.1354,-0.418 0.418,-0.418 z"
            />
            <path
              id="path4144"
        ...
        <button
          id="previewWin"
          onClick={() => this.props.togglePreviewPanel()}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 90 90"
