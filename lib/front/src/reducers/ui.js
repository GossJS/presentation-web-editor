  ...
  switch (action.type) {
    case 'SET_THEME':
      return Object.assign({}, state, {
        ...
        customThemePath: action.themePath
          ? action.themePath
          : state.customThemePath,
      });
    ...
    case 'CUSTOM_THEME_DELETE_SUCCESS':
      return Object.assign({}, state, {
        customThemes: state.customThemes.filter(theme => theme != action.theme),
      });

    case 'CUSTOM_THEME_LOAD_SUCCESS':
      return Object.assign({}, state, {
        customThemes: state.customThemes.concat(action.theme),
      });
